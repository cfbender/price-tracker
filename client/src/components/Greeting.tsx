...
import bonobos from "../img/bonobos.png";

const logos = [
  { name: "amazon", logo: amazon },
  { name: "target", logo: target },
  { name: "walmart", logo: walmart },
  { name: "newegg", logo: newegg },
  { name: "bonobos", logo: bonobos }
];
    ...
    <div className="container mx-auto mt-6 flex flex-col items-center justify-center align-middle">
      <div className="flex flex-auto my-16 justify-center">
        ...
        <svg
          ...
          className="hero-svg flex-auto hidden sm:block"
          data-name="Layer 1"
      ...
      <div className="flex flex-auto flex-col flex-wrap items-center mx-auto">
        <h2 className="text-xl sm:text-3xl mb-2">
          Track prices on these online stores:
        </h2>
        <p className="mb-10 flex-auto">
          Submit an issue on GitHub to add more to the project!
        </p>
